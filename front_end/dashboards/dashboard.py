...
class Metric:
    def __init__(self, title: str, formula_markdown: str, description: str, interactive_calculator_func,calculation_func, image_path: str, inputs: list):
        self.title = title
    ...
    def display_interactive_calculator(self, container):
        print("DISPLAY INTERACTIVE CALCULATOR: ", self.title)
        # self.interactive_calculator_func(container, *self.inputs)
