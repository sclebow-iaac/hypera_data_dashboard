...
def display_data(extracted_data, verbose=True, header=True, show_table=True, gauge=True, simple_table=False):
    data_extractor.display_data(data, extracted_data, model_name, verbose=verbose, header=header, show_table=show_table, gauge=gauge, simple_table=simple_table)